export const noteData = {
  ...
  breadcrumb: ["Notes", "Roman Legacy"],
  overview:
    "This chapter explores the origins and early development of Rome, tracing its transformation from a small settlement to a dominant power, and introduces key aspects of its governance, military, and cultural influences.",
  keyInsights: [
    "Rome's strategic location and open-door policy fostered its growth into a large metropolitan city.",
    "The Roman Republic was established through a struggle for rights between patricians and plebeians, leading to significant legal and political advancements.",
    "Rome's military reforms and alliance strategies were crucial in its expansion and dominance over rivals like Carthage.",
  ],
  sections: [
    {
...
export const chatTools = [
  ...
  { name: "Mind map", colorClass: "bg-tool-mindmap", key: "mindmap" },
...
export const workspaceTools = [
  ...
  { name: "Fill the blanks", key: "fill" },
  { name: "Mind Map", key: "mindmap" },
