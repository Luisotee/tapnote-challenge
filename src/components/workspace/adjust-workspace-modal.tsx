...
import { FileText, StickyNote, MessageCircle, ChevronDown } from "lucide-react";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
                ...
                <div key={block.id} className="flex flex-col items-center gap-1.5">
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <button
                        className={cn(
                          "relative flex h-14 w-14 items-center justify-center rounded-xl border transition-colors",
                          isActive
